...
export interface tb_site_sch_work_middleAttributes {
  code: number;
  major_code: number;
  view_text: string;
...
export type tb_site_sch_work_middlePk = "code";
export type tb_site_sch_work_middleId = tb_site_sch_work_middle[tb_site_sch_work_middlePk];
export type tb_site_sch_work_middleOptionalAttributes = "reg_dt" | "update_dt";
export type tb_site_sch_work_middleCreationAttributes = Optional<tb_site_sch_work_middleAttributes, tb_site_sch_work_middleOptionalAttributes>;

export class tb_site_sch_work_middle extends Model<tb_site_sch_work_middleAttributes, tb_site_sch_work_middleCreationAttributes> implements tb_site_sch_work_middleAttributes {
  code!: number;
  major_code!: number;
  view_text!: string;
  register_code!: number;
  ...
  // tb_site_sch_work_middle belongsTo tb_account via register_code
  ...
  // tb_site_sch_work_middle belongsTo tb_account via updater_code
  ...
  // tb_site_sch_work_middle belongsTo tb_site_sch_work_major via major_code
  ...
  // tb_site_sch_work_middle hasMany tb_site_sch_work via middle_code
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof tb_site_sch_work_middle {
    return tb_site_sch_work_middle.init({
    code: {
      autoIncrement: true,
    ...
    sequelize,
    tableName: 'tb_site_sch_work_middle',
    schema: 'public',
    timestamps: false,
    indexes: [
      {
        name: "tb_site_sch_work_middle_idx",
        fields: [
          { name: "major_code" },
        ]
      },
      {
        name: "tb_site_sch_work_middle_pkey",
        unique: true,
        fields: [
          { name: "code" },
        ]
